...
<div x-cloak class="w-full h-full flex justify-center relative" x-show='conformationModalDisplaying'>
    ...
    <div class="flex flex-col m-4 bg-white rounded-lg overflow-y-auto shadow-xl transform transition-all p-2 fixed top-20 ">
        ...
        <button x-on:click='conformationModalDisplaying = ! conformationModalDisplaying'>Yes</button>
